...
export default function OnePieceCardPage() {
 ...
 <p className="text-3xl font-semibold text-[#6366f1] mt-1">{fmtPrice(card.market_price)}</p>
 </div>
 {card.inventory_price && (
 <div className="text-right">
 <p className="text-xs text-[#8b8fa6] font-medium">{s.cardDetails}</p>
 <p className="text-lg font-semibold text-[#1e2235]">{fmtPrice(card.inventory_price)}</p>
 </div>
 )}
 </div>
 </div>
 ...
 {card.color && (
 <span className="px-3 py-1.5 bg-[#6366f1] text-[#6366f1] border border-[#6366f1] rounded-lg text-sm font-medium">
 {card.color}
 </span>
 )}
 {card.cost && (
 <span className="px-3 py-1.5 bg-[#6366f1]/10 text-[#6366f1] border border-[#6366f1]/20 rounded-lg text-sm font-medium">
 ...
 {card.attribute && (
 <span className="px-3 py-1.5 bg-gray-50 text-[#5c6078] border border-[#e8eaf0] rounded-lg text-sm font-medium">
 {card.attribute}
 </span>
 )}
 </div>
