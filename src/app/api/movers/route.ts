...
const HOT_CARDS: PriceEntry[] = [
  ...
  { name: 'Monkey D. Luffy', game: 'onepiece', setId: 'OP01', setName: 'Romance Dawn', number: '001', rarity: 'Leader', image: '/api/proxy-image?url=https%3A%2F%2Foptcgapi.com%2Fmedia%2Fstatic%2FCard_Images%2FOP01-001.jpg', price: 32.50, priceChange: 4.88, priceChangePercent: 17.6, direction: 'up' },
  { name: 'Roronoa Zoro', game: 'onepiece', setId: 'OP01', setName: 'Romance Dawn', number: '022', rarity: 'Super Rare', image: '/api/proxy-image?url=https%3A%2F%2Foptcgapi.com%2Fmedia%2Fstatic%2FCard_Images%2FOP01-022.jpg', price: 28.00, priceChange: 3.92, priceChangePercent: 16.3, direction: 'up' },
  ...
  { name: 'Nami', game: 'onepiece', setId: 'OP01', setName: 'Romance Dawn', number: '009', rarity: 'Rare', image: '/api/proxy-image?url=https%3A%2F%2Foptcgapi.com%2Fmedia%2Fstatic%2FCard_Images%2FOP01-009.jpg', price: 15.00, priceChange: -1.80, priceChangePercent: -10.7, direction: 'down' },
  { name: 'Sanji', game: 'onepiece', setId: 'OP02', setName: 'Paramount War', number: '018', rarity: 'Super Rare', image: '/api/proxy-image?url=https%3A%2F%2Foptcgapi.com%2Fmedia%2Fstatic%2FCard_Images%2FOP02-018.jpg', price: 22.00, priceChange: -2.86, priceChangePercent: -11.5, direction: 'down' },
]
