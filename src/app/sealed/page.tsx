...
export default function SealedPage() {
 ...
 <div className="animate-pulse h-5 w-3/4 rounded" />
 <div className="animate-pulse h-3 w-1/2 rounded" />
 </div>
 </div>
 ))}
 </div>
 ...
 >
 {/* Set logo */}
 <div className="h-32 bg-[#6366f1] flex items-center justify-center p-4">
 <img
 src={product.logo}
 alt={product.name}
 ...
 className="flex items-center justify-between px-3 py-2 bg-[#fafbfc] border border-[#e8eaf0] rounded-xl text-sm hover:border-[#6366f1]/30 hover:text-[#6366f1] transition-all group"
 >
