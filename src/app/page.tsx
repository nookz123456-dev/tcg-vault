...
export default function Home() {
 ...
 <Link
 href="/search"
 className="group px-8 py-4 bg-[#6366f1] text-white font-semibold rounded-xl hover:bg-[#4f46e5] transition-all text-lg"
 >
 {t('home.hero.cta')}
 ...
 <Link
 href="/sets"
 className="px-8 py-4 bg-white border border-[#e8eaf0] text-[#5c6078] font-semibold rounded-xl hover:text-[#6366f1] hover:border-[#6366f1]/30 transition-all text-lg"
 >
 {t('home.hero.cta2')}
 </Link>
 </div>
 ...
 <div key={i} className="group bg-white border border-[#e8eaf0] rounded-2xl p-8 hover:shadow-md hover:border-[#6366f1]/20 transition-all duration-200">
