...
const translations = {
  ...
  // Decks
  'mhr.nav.decks': { th: 'เด็ค', en: 'Decks' },
  'mhr.deck.title': { th: 'เด็คของฉัน', en: 'My Decks' },
  'mhr.deck.subtitle': { th: 'จัดเด็คการ์ด Marvel Hero Rush · เก็บไว้ในเครื่องนี้', en: 'Build Marvel Hero Rush decks · saved on this device' },
  'mhr.deck.new': { th: 'สร้างเด็คใหม่', en: 'New deck' },
  'mhr.deck.newName': { th: 'ชื่อเด็ค…', en: 'Deck name…' },
  'mhr.deck.create': { th: 'สร้าง', en: 'Create' },
  'mhr.deck.empty': { th: 'ยังไม่มีเด็ค', en: 'No decks yet' },
  'mhr.deck.emptyHint': { th: 'สร้างเด็คแรกของคุณเพื่อเริ่มจัดการ์ด', en: 'Create your first deck to start building' },
  'mhr.deck.cards': { th: 'ใบ', en: 'cards' },
  'mhr.deck.value': { th: 'มูลค่า', en: 'Value' },
  'mhr.deck.open': { th: 'เปิด', en: 'Open' },
  'mhr.deck.delete': { th: 'ลบ', en: 'Delete' },
  'mhr.deck.deleteConfirm': { th: 'ลบเด็คนี้?', en: 'Delete this deck?' },
  'mhr.deck.back': { th: 'เด็คทั้งหมด', en: 'All decks' },
  'mhr.deck.notFound': { th: 'ไม่พบเด็ค', en: 'Deck not found' },
  'mhr.deck.addCards': { th: 'เพิ่มการ์ดลงเด็ค', en: 'Add cards to deck' },
  'mhr.deck.search': { th: 'ค้นหาการ์ด (ชื่อ / เลขการ์ด)', en: 'Search cards (name / card no.)' },
  'mhr.deck.inDeck': { th: 'ในเด็ค', en: 'In deck' },
  'mhr.deck.totalCards': { th: 'การ์ดทั้งหมด', en: 'Total cards' },
  'mhr.deck.totalValue': { th: 'มูลค่ารวม', en: 'Total value' },
  'mhr.deck.deckEmpty': { th: 'เด็คนี้ยังว่าง — ค้นหาการ์ดด้านบนแล้วกด +', en: 'This deck is empty — search above and tap +' },
  'mhr.deck.rename': { th: 'เปลี่ยนชื่อ', en: 'Rename' },
  'mhr.deck.byRarity': { th: 'แยกตามเรต', en: 'By rarity' },
  'mhr.deck.addTo': { th: 'เพิ่มลงเด็ค', en: 'Add to deck' },
  'mhr.deck.added': { th: 'เพิ่มแล้ว', en: 'Added' },
  'mhr.deck.pickDeck': { th: 'เลือกเด็ค', en: 'Choose a deck' },
} as const
