...
// Aurora — flowing WebGL aurora ribbons (React Bits, adapted to Vaultverse
// Marvel/multiverse colors). Uses `ogl` (no framer-motion/GSAP).
...
export default function Aurora({
  colorStops = ['#ff2b39', '#a855f7', '#22d3ee'],
  amplitude = 1.0,
  blend = 0.5,
  speed = 1.0,
}: AuroraProps) {
